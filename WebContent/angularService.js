...
app.factory('angularService', function($http) {
	...
	// Base url of RESTfullservice
	var BASE_URL = "http://localhost:8098/WebService"

	var angularService = this;

	// APR object passing to the HTTP Request POST method and responding by
	// returning an object after calculating APR
	angularService.calculateAPR = function(apr) {
		console.log('entering APR calculation')
		return $http.post(BASE_URL + "/APR/", apr).then(function(response) {
